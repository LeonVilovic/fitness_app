 ...
 * @author Marija
 */
public class SOPretraziPlanoveVezbanja extends OpstaSistemskaOperacija {

    String kriterijumPretrage;
    List<OpstiDomenskiObjekat> rezultatPretrage;

    public SOPretraziPlanoveVezbanja(OpstiDomenskiObjekat odo, String kriterijumPretrage) {
        super(odo);
